...
<script>
  ...
  const Todos = {
    ...
    mounted() {
      ...
      //this.todos = [{description: 'Drink coffee', completed:false},{description: 'Write REST API', completed:false}];
    ...
    methods: {
      ...
      addTodo: function () {
        ...
        api.createNew(value).then( (response) => {  
      ...
      completeTodo: function(todo) {
        this.$log.debug("Complete: ", todo);
        api.updateForId(todo.id, todo.description, todo.completed).then((response) => {  
      ...
      doneEdit: function (todo) {
        ...
        api.updateForId(todo.id, todo.description.trim(), todo.completed).then((response) => {
            this.$log.info("Item updated:", response.data);  
            this.editedTodo = null; 
            todo.description = todo.description.trim();  
          }).catch((error) => {  
